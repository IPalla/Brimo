...
\documentclass[tfg, overleaf, epsbased,loe,lof,lot, final]{tfgtfmthesisuam}
...
\input{cap_desarrollo}

\input{cap_pruebas}

\input{cap_trabajofuturo}
...
\nocite{
    ...
    OCR:ModeloCascada,
    Express:Docs,
    HGT:SistemasDomoticos,
    MarkCoppock:UnderstandingSmartHomeProtocols,
    DI:InstalacionesDomoticas,
    AL:ZigBee,
    Wiki:Bluetooth,
    Inst:InstTech,
    ED:Insteon,
